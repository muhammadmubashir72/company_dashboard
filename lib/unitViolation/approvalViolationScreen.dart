...
class approvalViolationScreen extends StatefulWidget {
  @override
  State<approvalViolationScreen> createState() =>
      _approvalViolationScreenState();
}

class _approvalViolationScreenState extends State<approvalViolationScreen> {
